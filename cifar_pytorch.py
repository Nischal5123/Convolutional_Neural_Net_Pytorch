...
class Net(nn.Module):
    def __init__(self):
        ...
        # TODO
        self.conv1 = nn.Conv2d(3, 32, 3, padding=1)  # Conv with 32 3x3 filters and padding 1
        self.relu1 = nn.ReLU()
        self.conv2 = nn.Conv2d(32, 32, 3, padding=1)  # Conv with 32 3x3 filters and padding 1
